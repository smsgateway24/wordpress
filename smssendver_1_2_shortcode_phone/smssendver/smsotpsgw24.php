...
//header('Location: /wp-content/plugins/smssendver/index1.html');	// переход на страницу index1.html
...
// Форма панели администратора
	...
	<tr>&nbsp;</tr>
	<td style='text-align:left;'>Ваш shorcode для добавление plugin с выбором страны: [smsgateway24country/]</td> 
	<td </td>
	<tr>&nbsp;</tr>
	</table>
	";
